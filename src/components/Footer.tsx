...
const Footer = () => {
  ...
  return (
    <footer className="bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white pt-4 overflow-hidden">
      {/* Background Pattern */}
      ...
      <div className="relative container mx-auto px-4 pt-24 pb-16">
        ...
        <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-8 mb-8 border border-white/10">
          <div className="text-center max-w-2xl mx-auto">
            ...
            <p className="text-gray-300 mb-6">Subscribe to our newsletter for the latest products and exclusive offers.</p>
